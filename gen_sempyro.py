...
link_dicts = [
    ...
    {
        "schema_path": linkml_definitions_path
        / "hri"
        / "hri-Distribution.yaml",
...
for link_dict in link_dicts:
    ...
    remove_unwanted_classes(
        Path(link_dict["output_path"]), Path(link_dict["schema_path"])
    )
