...
class HRIDistribution(DCATDistribution):
    ...
    dcat_access_service: Optional[Union[AnyHttpUrl, HRIDataService]] = Field(
        default=None,
    ...
    dcat_access_url: AnyHttpUrl = Field(
    ...
    dcat_compression_format: Optional[AnyHttpUrl] = Field(
        default=None,
    ...
    dct_description: Optional[list[LiteralField]] = Field(
        default=None,
    ...
    dcat_download_url: Optional[AnyHttpUrl] = Field(
        default=None,
    ...
    dct_license: Union[AnyHttpUrl, GeonovumLicenses] = Field(
    ...
    dct_linked_schemas: Optional[list[AnyHttpUrl]] = Field(
        default=None,
        description="""An established standard to which the described resource conforms.""",
        json_schema_extra={"rdf_term": DCTERMS.conformsTo, "rdf_type": "uri"},
    )

    dcat_media_type: Optional[AnyHttpUrl] = Field(
        default=None,
    ...
    dcat_packaging_format: Optional[AnyHttpUrl] = Field(
        default=None,
    ...
    healthdcatap_retention_period: Optional[Union[AnyHttpUrl, PeriodOfTime]] = Field(
        default=None,
    ...
    dct_rights: AnyHttpUrl = Field(
        description="""Information about rights held in and over the resource.""",
        json_schema_extra={"rdf_term": DCTERMS.rights, "rdf_type": "uri"},
    )

    adms_status: Optional[Union[AnyHttpUrl, DistributionStatus]] = Field(
        default=None,
    ...
    dct_title: list[LiteralField] = Field(
