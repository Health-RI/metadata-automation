...
class HRIDataset(DCATDataset):
    ...
    healthdcatap_analytics: Optional[list[Union[AnyHttpUrl, DCATDistribution]]] = Field(
        default=None,
        description="""An analytics distribution of the dataset.""",
        json_schema_extra={"rdf_term": HEALTHDCATAP.analytics, "rdf_type": "uri"},
    )

    dcatap_applicable_legislation: list[AnyHttpUrl] = Field(
    ...
    healthdcatap_code_values: Optional[list[AnyHttpUrl]] = Field(
        default=None,
    ...
    healthdcatap_coding_system: Optional[list[AnyHttpUrl]] = Field(
        default=None,
    ...
    dct_conforms_to: Optional[list[AnyHttpUrl]] = Field(
        default=None,
    ...
    dct_creator: list[Union[AnyHttpUrl, HRIAgent]] = Field(
    ...
    dcat_distribution: Optional[list[Union[AnyHttpUrl, DCATDistribution]]] = Field(
        default=None,
        description="""An available Distribution for the Dataset.""",
        json_schema_extra={"rdf_term": DCAT.distribution, "rdf_type": "uri"},
    )

    foaf_documentation: Optional[list[AnyHttpUrl]] = Field(
        default=None,
    ...
    dcat_has_version: Optional[list[AnyHttpUrl]] = Field(
        default=None,
    ...
    healthdcatap_health_theme: Optional[list[AnyHttpUrl]] = Field(
        default=None,
    ...
    dcat_in_series: Optional[list[Union[AnyHttpUrl, DCATDatasetSeries]]] = Field(
        default=None,
        description="""A dataset series of which the dataset is part.""",
        json_schema_extra={"rdf_term": DCATv3.inSeries, "rdf_type": "uri"},
    )

    dct_is_referenced_by: Optional[list[AnyHttpUrl]] = Field(
        default=None,
    ...
    dcat_keyword: list[LiteralField] = Field(
    ...
    dpv_legal_basis: Optional[list[AnyHttpUrl]] = Field(
        default=None,
        description="""Indicates use or applicability of a Legal Basis.""",
        json_schema_extra={"rdf_term": DPV.hasLegalBasis, "rdf_type": "uri"},
    )

    healthdcatap_maximum_typical_age: Optional[Union[LiteralField, int]] = Field(
        default=None,
    ...
    healthdcatap_minimum_typical_age: Optional[Union[LiteralField, int]] = Field(
        default=None,
    ...
    healthdcatap_number_of_records: Optional[Union[LiteralField, int]] = Field(
        default=None,
    ...
    healthdcatap_number_of_unique_infividuals: Optional[Union[LiteralField, int]] = Field(
        default=None,
    ...
    dpv_purpose: Optional[list[AnyHttpUrl]] = Field(
        default=None,
        description="""Indicates association with Purpose.""",
        json_schema_extra={"rdf_term": DPV.hasPurpose, "rdf_type": "uri"},
    )

    prov_qualified_attribution: Optional[list[Union[AnyHttpUrl, Attribution]]] = Field(
        default=None,
        description="""Attribution is the ascribing of an entity to an agent.""",
        json_schema_extra={"rdf_term": PROV.qualifiedAttribution, "rdf_type": "uri"},
    )

    dcat_qualified_relation: Optional[list[Union[AnyHttpUrl, Relationship]]] = Field(
        default=None,
    ...
    dcat_temporal_resolution: Optional[Union[LiteralField, str]] = Field(
        default=None,
    ...
    dct_type: Optional[list[AnyHttpUrl]] = Field(
        default=None,
        description="""The nature or genre of the resource.""",
        json_schema_extra={"rdf_term": DCTERMS.type, "rdf_type": "uri"},
    )

    dcat_version: Optional[Union[LiteralField, str]] = Field(
        default=None,
        description="""The version indicator (name or identifier) of a resource.""",
        json_schema_extra={"rdf_term": DCATv3.version, "rdf_type": "rdfs_literal"},
    )

    adms_version_notes: Optional[list[Union[LiteralField, str]]] = Field(
        default=None,
    ...
    prov_was_generated_by: Optional[list[Union[Activity, AnyHttpUrl]]] = Field(
        default=None,
