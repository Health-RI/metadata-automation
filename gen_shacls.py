...
from metadata_automation.shacl.utils import generate_from_linkml, remove_empty_node_shapes, remove_redundant_constraints, fix_uri_node_kinds, remove_ignored_properties, remove_anyuri_datatype, remove_closed_properties
...
for link_dict in link_dicts:
    ...
    remove_closed_properties(link_dict['output_path'])
